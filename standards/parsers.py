                        ...
                        if len(left_split) == 2:
                            if left_split[0].isdigit() and left_split[1].isdigit():
                                if ':' in split[1]:
                                    ...
                                    if len(right_split) == 2:
                                        if right_split[0].isdigit() and right_split[1].isdigit():
                                            result.append([int(left_split[0]),
                                                           int(left_split[1]),
                                                           int(right_split[0]),
                                                           int(right_split[1])])  # 1:2-2:1
                                        else:
                                            malformed = True  # 1:2-a:1, 1:2-2:b
                                    else:
                                        malformed = True  # 1:2-2:, 1:2-2:1:, 1:2-2:1:2
                                    ...
                                    malformed = True  # 1:2-a
                            else:
                                malformed = True  # a:2-2:1, 1:b-2:1
                        else:
                            malformed = True  # 1:-2:1, 1:2:-2:1, 1:2:3-2:1
                    else:
                ...
                if ':' in i:
                    ...
                    if len(split) == 2:
                        if split[0].isdigit() and split[1].isdigit():
                            ...
                            malformed = True  # a:1, 1:b
                    else:
                        malformed = True  # 1:2:3, 1:, :
                else:
                    malformed = True  # 1
    return result, malformed
