...
class WCF:
    ...
    def getText(self, fromChptr, fromPara, toChptr, toPara):
        if (0 < fromChptr and fromChptr <= toChptr and toChptr <= 33) and (0 < fromPara and fromPara <= self.CHPTRMAX[fromChptr]) and (0 < toPara and toPara <= self.CHPTRMAX[toChptr]):
            result = ''
